...
|絵|トランプカード紋様|
|絵の配置|カードの真ん中(横、縦)に１個|
|必要枚数|４枚(トランプカード紋様１個づつ)|

|特記事項||
|--|--|
|- プレイヤーカード、進行カード、アクションカードは共通化||
|- プレイヤーフィルドは芝であることをわかるように緑系の背景色||
|- アクションフィルドは紫系の背景色||
|- プレイヤーカードとアクションカードの大きさは同一||
|- 進行カードは上記２種類のカードより1.2倍の大きさ||
...
- フィルドタイルの基本コンポーネント
- 背景色の切り替え（プレイヤーフィルド：緑系/アクションフィルド：紫系）
...
#### 手動検証
- ライブラリページでコンポーネント確認（各サイズバリエーション）
- ゲームプレイのフロー確認
- 進行カードクリック→カード移動→アクションカード発動→勝利表示→再スタートの一連の流れ確認
- ページ切り替えボタンの動作確認
